...
class CNN():
    ...
    def accGraph(self):
        ...
        plt.figure()
        plt.plot(arr, self.history.history["accuracy"], label="train_acc")
        plt.plot(arr, self.history.history["val_accuracy"], label="val_acc")
    ...
    def predictGraph(self, testDir):
        ...
        predicted_values = self.model.predict(score_generator, steps=score_generator.n//score_generator.batch_size, verbose=1)
